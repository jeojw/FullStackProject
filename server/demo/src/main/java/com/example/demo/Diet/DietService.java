...
public class DietService {
    ...
    public List<DietDto> searchDietListByOption(SearchDto searchDto){
        ...
        if (user.isPresent()){
            Optional<List<Long>> riceIdList = riceRepository.getRiceEntityId(searchDto.getSearchRice());
            Optional<List<Long>> soupIdList = soupRepository.getSoupEntityId(searchDto.getSearchRice());
            Optional<List<Long>> sideDishIdList = sideDishRepository.getSideDishEntityId(searchDto.getSearchSideDish());
