...
import 'find_password_model.dart';
export 'find_password_model.dart';
...
class _FindPasswordWidgetState extends State<FindPasswordWidget> {
  ...
  void initState() {
    ...
    _model.authNumberFieldTextController ??= TextEditingController();
    _model.authNumberFieldFocusNode ??= FocusNode();
  }
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          focusNode: _model.authNumberFieldFocusNode,
                          autofocus: false,
                          obscureText: false,
                          decoration: InputDecoration(
                            isDense: true,
                            labelText: 'Auth Number',
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  fontFamily: 'Inter',
